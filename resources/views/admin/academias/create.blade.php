...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Cadastrar Academia</h1>
    </div>
    <div class="col-sm-6">
...
<form action="{{ route('tenant.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf     
<div class="row">            
<div class="col-12">
            ...
            <div class="row mb-4 text-muted">            
                ...
                <div class="col-12 col-md-6 col-lg-4"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cnpjmask" name="cnpj" value="{{ old('cnpj') }}">
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4"> 
                    <div class="form-group">
                        <label class="labelforms"><b>Inscrição Estadual:</b></label>
                        <input type="text" class="form-control" placeholder="Inscrição Estadual" name="ie" value="{{old('ie') }}">
                    </div>
                </div>
                <div class="col-12 col-md-3 col-lg-2"> 
                    <div class="form-group">
                        <label class="labelforms"><b>Ano de ínicio</b></label>
                        <input type="text" class="form-control" placeholder="Ano de ínicio" name="init_date" value="{{old('init_date') }}">
                    </div>
                </div>
                <div class="col-12 col-md-3 col-lg-2"> 
                    <div class="form-group">
                ...
                <div class="col-12 col-md-6 col-lg-6"> 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subdomain" value="{{ old('subdomain') }}" {{(\Illuminate\Support\Facades\Auth::user()->superadmin == true ? '' : 'disabled')}}>
                    </div>
                </div>                        
            </div>
                            ...
                            <div class="row mb-2 text-muted">  
                                ...
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Email Adicional" name="additional_email" value="{{old('additional_email') }}">
                                    </div>
                                </div>   
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control telefonemask" placeholder="Número do Telefone com DDD" name="phone" value="{{old('phone') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                                        <label class="labelforms"><b>*Celular:</b></label>
                                        <input type="text" class="form-control celularmask" placeholder="Número do Celular com DDD" name="cell_phone" value="{{old('cell_phone') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                            ...
                            <div class="row mb-2">
                                <div class="col-12 col-md-3 col-lg-2"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mask-zipcode" id="cep" placeholder="Digite o CEP" name="postcode" value="{{old('postcode') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-3 col-lg-3"> 
                                    <div class="form-group">
                                        <label class="labelforms"><b>Estado:</b></label>
                                        <input type="text" class="form-control" name="state" id="uf" value="{{old('state') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3"> 
                                    <div class="form-group">
                                        <label class="labelforms"><b>Cidade:</b></label>
                                        <input type="text" class="form-control" name="city" id="cidade" value="{{old('city') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4"> 
                                    <div class="form-group">
                                        <label class="labelforms"><b>Bairro:</b></label>
                                        <input type="text" class="form-control" name="neighborhood" id="bairro" value="{{old('neighborhood') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6"> 
                                    <div class="form-group">
                                        <label class="labelforms"><b>Rua:</b></label>
                                        <input type="text" class="form-control" name="street" id="rua" value="{{old('street') }}">
                                    </div>
                                </div>
            ...
            <div class="row mb-2 text-muted">
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">                                                    
                            <img id="preview2" width="{{env('LOGOMARCA_WIDTH')}}" height="{{env('LOGOMARCA_HEIGHT')}}" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">                                                    
                            <img id="preview3" width="{{env('LOGOMARCA_GERENCIADOR_WIDTH')}}" height="{{env('LOGOMARCA_GERENCIADOR_HEIGHT')}}" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">                                                    
                            <img id="preview4" width="{{env('FAVEICON_WIDTH')}}" height="{{env('FAVEICON_HEIGHT')}}" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">                                                    
                            <img id="preview5" width="{{env('MARCADAGUA_WIDTH')}}" height="{{env('MARCADAGUA_HEIGHT')}}" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
                ...
                <div class="col-12"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">
                            <img id="preview6" width="{{env('IMGHEADER_WIDTH')}}" height="{{env('IMGHEADER_HEIGHT')}}" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
        ...
        <div class="tab-pane fade" id="custom-tabs-four-seo" role="tabpanel" aria-labelledby="custom-tabs-four-seo-tab">
            <div class="row mb-2 text-muted">
                ...
                <div class="col-12">   
                    ...
                    <x-adminlte-text-editor name="information" v placeholder="Descrição..." :config="$config">{{ old('information') }}</x-adminlte-text-editor>                                                                                     
                </div>
                ...
                <div class="col-12 mb-1">   
                    <div class="form-group">
                        ...
                        <textarea id="inputDescription" class="form-control" rows="5" name="maps_google">{{ old('maps_google') }}</textarea> 
                    </div>                                                     
                </div>
                <div class="col-12 mb-1"> 
                    <div class="form-group">
                        ...
                        <div class="thumb_user_admin">                                                    
                            <img id="preview1" src="{{url(asset('backend/assets/images/image.jpg'))}}" alt="{{ old('domain') }}" title="{{ old('domain') }}"/>
                ...
                <div class="col-12">   
                    ...
                    <x-adminlte-text-editor name="politicas_de_privacidade" v placeholder="Política de Privacidade..." :config="$config">{{ old('privacy_policy') }}</x-adminlte-text-editor>                                                                                     
                </div>
            </div> 
        </div>        
